...
public class AcceptanceTestPanel extends JPanel{
	...
	private JTextArea content;//The actual message component of the acceptance test to be displayed in this panel, stored in a JTextArea
	 ...
	 */
	public AcceptanceTestPanel(String acceptanceTestTitle, String message){
		...
		title = acceptanceTestTitle;//Set the "title"
		...
		TitledBorder titleBorder = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED), acceptanceTestTitle); //First create a titled and (lowerd) etched border, using the provided title
