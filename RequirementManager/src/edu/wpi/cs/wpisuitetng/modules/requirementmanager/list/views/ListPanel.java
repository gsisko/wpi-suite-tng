...
/**
 * Panel to hold the three portions of the requirement search interface. The
...
//	protected FilterListPanel filtersPanel;
	...
	/** Panel containing the results of the requirement search */
	...
	*/	
		...
		layout.putConstraint(SpringLayout.NORTH, resultsPanel, 0, SpringLayout.SOUTH, this);
		layout.putConstraint(SpringLayout.WEST, resultsPanel, 0, SpringLayout.EAST, this);
