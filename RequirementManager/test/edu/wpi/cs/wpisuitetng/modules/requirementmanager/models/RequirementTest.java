...
public class RequirementTest {
	...
	public final void testRequirement() {
		...
		//Test normal input
		test = new Requirement("Test", "JUnit test requirement", NoType, NoPriority, 0);
		test = null;
		
		//Test garbage and illegal input
		test = new Requirement(null, null, null, null, 0);
		test = null;
...
//		Requirement tester = new Requirement("Test", "Test requirement for JUnit", 0, 0, null, null, 0, 0);
		Requirement tester = new Requirement(null, null, null, null, 0);
		tester.save();
	...
	public final void testSetDescription() {
		Requirement test = new Requirement(null, null, null, null, 0);
